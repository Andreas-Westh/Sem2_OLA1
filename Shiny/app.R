...
allmatches <- readRDS(here::here("Shiny", "Data", "allmatches.rds"))
allshots <- readRDS(here::here("Shiny", "Data", "allshots.rds"))
allplayers <- readRDS(here::here("Shiny", "Data", "allplayers.rds"))
allpasses <- readRDS(here::here("Shiny", "Data", "passesflat.rds"))
